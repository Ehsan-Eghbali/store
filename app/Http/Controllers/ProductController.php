...
{
    public function __construct (private ProductServiceRepository $productServiceRepository,private BrandServiceRepository $brandServiceRepository)
    {
    ...
    public function index(Request $request)
    {
        ...
        $dataTypeContent->transform(function ($item, $key)  {
    ...
    public function create(Request $request)
    {
        ...
        $brands = $this->brandServiceRepository->all()->pluck('name','id');
        // Set the field to 'select_dropdown' type
        foreach ($dataType->addRows as $row) {
            if ($row->field == 'brand_id') {
                $row->type = 'select_dropdown';
                $row->details = ['options' => $brands];
            }
        }
//        dd($dataType->addRows);
...
//    }
    ...
    public function edit(Request $request, $id)
    {
        ...
        // Transforming $dataTypeContent to add 'brand_id' field
//        $dataTypeContent->brand_id = $dataTypeContent->brand->name;
        $brands = $this->brandServiceRepository->all()->pluck('name','id');
